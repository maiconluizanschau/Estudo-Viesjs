		...
		<div class="conteudo">
			<form class="painel">
				...
				<Rotulo nome="Prioridade">
					<select name="" id="">
						<option :value="prioridade.codigo" v-for="prioridade in prioridades" :key="prioridade.codigo">{{prioridade.nome}}</option>
					</select>
				</Rotulo>
			...
			<div class="painel">
				...
				<Rotulo nome="Mensagem">
					<span style="while-space: pre;">{{usuario.mensagem}}</span>
				</Rotulo>
